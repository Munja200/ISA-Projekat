...
import FTN.isa.service.ReportService;
...
public class ReportConroller {
	...
	private ReportService reportService;
		...
		//"api/reports/add"
		@Operation(summary = "Register new report", description = "Register new report", method = "POST")
		@ApiResponses(value = {
		...
		public ResponseEntity<Report> saveReport(@RequestBody @Valid Report report)  {
			...
			try {
				...
				e.printStackTrace();
				return new ResponseEntity<Report>(report, HttpStatus.CONFLICT);
			}
		}
